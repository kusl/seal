...
<img src="fastlane/metadata/android/en-US/images/icon.png" width=160 height=160 align="center">
...
[![GitHub release (latest by date)](https://img.shields.io/github/v/release/kusl/seal?color=black&label=Release&logo=github)](https://github.com/kusl/seal/releases/latest/)
[![GitHub release (latest by date including pre-releases)](https://img.shields.io/github/v/release/kusl/seal?include_prereleases&label=Preview&logo=Github)](https://github.com/kusl/seal/releases/)
[![Supported-Sites](https://img.shields.io/badge/Sites-9cf?style=flat&logo=data:image/svg+xml;base64,&label=Supported)](https://github.com/yt-dlp/yt-dlp/blob/master/supportedsites.md)

</div>

> [!Important]
>
> **This is a personal fork of [JunkFood02/Seal](https://github.com/JunkFood02/Seal) maintained by [@kusl](https://github.com/kusl).** It diverges from upstream in several ways described below. For the original app, see the upstream repository.
...
- Download videos and audio files from platforms supported by [yt-dlp](https://github.com/yt-dlp/yt-dlp) (formerly youtube-dl).
- Embed metadata and video thumbnails into extracted audio files via [mutagen](https://github.com/quodlibet/mutagen).
- Download entire playlists with one tap.
- Use embedded [aria2c](https://github.com/aria2/aria2) as an external downloader.
...
- [Material Design 3](https://m3.material.io/) UI with dynamic color theming.
...
This fork is distributed via **[Obtainium](https://github.com/ImranR98/Obtainium)** — add `https://github.com/kusl/seal` as a source.
...
To help diagnose stability problems — in particular the UI freeze / ANR that can occur during heavy "copy link → switch app → paste → download" workflows — this build integrates [Sentry](https://sentry.io) for automatic crash, ANR, and diagnostic reporting.
...
Join the upstream [Telegram Channel](https://t.me/seal_app) or [Matrix Space](https://matrix.to/#/#seal-space:matrix.org) for discussion about the original Seal app.

For issues specific to this fork, open an issue at [github.com/kusl/seal](https://github.com/kusl/seal/issues).
...
> [!Note]
>
> For submitting bug reports, feature requests, questions, or any other ideas about the upstream app, please read [CONTRIBUTING.md](https://github.com/JunkFood02/Seal/blob/main/CONTRIBUTING.md) first.
...
Seal is a GUI for [yt-dlp](https://github.com/yt-dlp/yt-dlp), built on [youtubedl-android](https://github.com/yausername/youtubedl-android).

Some UI designs and code are adapted from [Read You](https://github.com/Ashinch/ReadYou) and [Music You](https://github.com/Kyant0/MusicYou).

[dvd](https://github.com/yausername/dvd) · [Material color utilities](https://github.com/material-foundation/material-color-utilities) · [Monet](https://github.com/Kyant0/Monet)
